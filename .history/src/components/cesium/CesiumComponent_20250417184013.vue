  ...
  Cesium.GeoJsonDataSource.load(url, {
    ...
    .then((dataSource) => {
      ...
      entities.forEach((entity) => {
        ...
        console.error(entity.properties.getValue(Cesium.JulianDate.now()));
        if (entity.properties?.hasProperty(labelField)) {
          name = entity.properties.getProperty(labelField);
        }
